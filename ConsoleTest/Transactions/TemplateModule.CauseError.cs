...
namespace FinalBiome.Sdk.Transactions
{
    public partial class TemplateModule
    {
        ...
        public async Task<string?> CauseError(Ajuna.NetApi.Model.Types.Account account,  Func<string, ExtrinsicStatus, Task>? subscription = null, CancellationToken? token = null)
        {
            byte[] parameters = new byte[] { };
            Method method = new Method(8, 1, parameters);
