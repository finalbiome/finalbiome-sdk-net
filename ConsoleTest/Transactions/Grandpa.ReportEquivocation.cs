...
namespace FinalBiome.Sdk.Transactions
{
    public partial class Grandpa
    {
        ...
        public async Task<string?> ReportEquivocation(Ajuna.NetApi.Model.Types.Account account, FinalBiome.Sdk.SpFinalityGrandpa.EquivocationProof equivocationProof, FinalBiome.Sdk.SpCore.Void keyOwnerProof, Func<string, ExtrinsicStatus, Task>? subscription = null, CancellationToken? token = null)
        {
            ...
            Method method = new Method(4, 0, parameters);
