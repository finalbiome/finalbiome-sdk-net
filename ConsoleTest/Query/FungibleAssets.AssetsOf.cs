...
namespace FinalBiome.Sdk.Query
{
    public partial class FungibleAssets
    {
        ...
        public async Task<FinalBiome.Sdk.Tuple_Empty> AssetsOf(FinalBiome.Sdk.SpCore.Crypto.AccountId32 accountId32, FinalBiome.Sdk.PalletSupport.Types.FungibleAssetId.FungibleAssetId fungibleAssetId, byte[]? hash = null, CancellationToken? token = null)
        {
