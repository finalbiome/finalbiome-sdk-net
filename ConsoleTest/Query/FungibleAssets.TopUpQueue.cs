...
namespace FinalBiome.Sdk.Query
{
    public partial class FungibleAssets
    {
        ...
        public async Task<FinalBiome.Sdk.Tuple_Empty> TopUpQueue(FinalBiome.Sdk.PalletSupport.Types.FungibleAssetId.FungibleAssetId fungibleAssetId, FinalBiome.Sdk.SpCore.Crypto.AccountId32 accountId32, byte[]? hash = null, CancellationToken? token = null)
        {
