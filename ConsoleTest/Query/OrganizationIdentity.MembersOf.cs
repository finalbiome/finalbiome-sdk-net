...
namespace FinalBiome.Sdk.Query
{
    public partial class OrganizationIdentity
    {
        ...
        public async Task<FinalBiome.Sdk.Tuple_Empty> MembersOf(FinalBiome.Sdk.SpCore.Crypto.AccountId32 accountId32, FinalBiome.Sdk.SpCore.Crypto.AccountId32 accountId320, byte[]? hash = null, CancellationToken? token = null)
        {
