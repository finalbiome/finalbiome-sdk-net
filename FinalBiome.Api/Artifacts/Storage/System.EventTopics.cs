...
public partial class System
{
    ...
    ///  no notification will be triggered thus the event might be lost.<br/>
    /// </summary>
    public async IAsyncEnumerable<FinalBiome.Api.Types.VecTuple_U32_U32?> EventTopicsSubscribe(FinalBiome.Api.Types.PrimitiveTypes.H256 h256, CancellationToken? cancellationToken = null)
    {
        List<StorageMapKey> storageEntryKeys = new List<StorageMapKey>();
        storageEntryKeys.Add(new StorageMapKey(h256, FinalBiome.Api.Storage.StorageHasher.Blake2_128Concat));
        ...
        var sub = client.Storage.SubscribeStorage<FinalBiome.Api.Types.VecTuple_U32_U32>(address, cancellationToken);
