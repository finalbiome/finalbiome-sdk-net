...
public class Timeouts : StorageEntry<FinalBiome.Api.Types.Tuple_Empty>
{
    ...
    /// </summary>
    public Timeouts(Client client, FinalBiome.Api.Types.Primitive.U32 u32, FinalBiome.Api.Types.PalletSupport.GamerAccount gamerAccount, FinalBiome.Api.Types.Primitive.U32 u320) :
        base(client, "Mechanics", "Timeouts")
    {
        ...
        storageEntryKeys.Add(new StorageMapKey(u320, FinalBiome.Api.Storage.StorageHasher.Twox64Concat));
